...
# ---------- Volcengine Browser sandbox -------------- #
# Create a browser sandbox
browser = sandbox.browser.create(provider="volcengine")
print(f"Sandbox ID: {browser.id}")
print(f"Status: {browser.status}")
print()

# Execute command
result = sandbox.sandboxes.execute(browser.id, command="echo 'Hello from Volcengine Browser!'")
print(result.stdout)
print()
